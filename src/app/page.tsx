...
const categories = [
  ...
  },
  {
    ...
    href: '/search?category=Heat Exchanger',
    Icon: () => <div className="h-12 w-12 flex items-center justify-center rounded-lg bg-red-100"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M14 12H10" stroke="#F87171" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M12 10V14" stroke="#F87171" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12Z" stroke="#F87171" stroke-width="1.5"/><path d="M18 18L21 21" stroke="#F87171" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M6 18L3 21" stroke="#F87171" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M18 6L21 3" stroke="#F87171" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M6 6L3 3" stroke="#F87171" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></div>,
  ...
  },
  {
    ...
    href: '/search?category=Distillation Column',
    Icon: () => <div className="h-12 w-12 flex items-center justify-center rounded-lg bg-yellow-100"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 2V22" stroke="#FBBF24" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M9 4H15" stroke="#FBBF24" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M9 20H15" stroke="#FBBF24" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M6 8H18" stroke="#FBBF24" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M6 16H18" stroke="#FBBF24" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M8 12H16" stroke="#FBBF24" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></div>,
