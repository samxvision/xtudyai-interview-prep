...
const categoryConfig = [
  ...
  },
  {
    ...
    Icon: () => <div className="h-8 w-8 md:h-9 md:w-9 flex items-center justify-center rounded-lg bg-cyan-100"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3.33331 11.6667L7.49998 7.5L12.5 12.5L16.6666 8.33334" stroke="#06B6D4" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><path d="M12.5 8.33334H16.6667V12.5" stroke="#06B6D4" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg></div>,
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-body">
      <header className="container mx-auto px-4 h-14 flex justify-between items-center">
        <Logo />
      ...
      <main className="container mx-auto px-4 py-4 md:py-8">
        <section className="text-center mb-8 md:mb-10">
            <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold font-headline mb-2 text-foreground leading-tight">Master Your <span className="text-primary">QA/QC</span> Career</h1>
            <p className="text-sm md:text-base text-muted-foreground max-w-2xl mx-auto">The ultimate companion for Oil & Gas inspection professionals.</p>
        </section>
             ...
             <div className="cursor-pointer">
                <Card className="hover:border-primary/40 transition-all shadow-sm hover:shadow-md border-border">
                    <CardContent className="p-3 md:p-4 flex items-center gap-3">
                        ...
                        <div>
                            <p className="font-semibold text-sm md:text-base text-foreground">Start Interview Prep</p>
                            <p className="text-xs md:text-sm text-muted-foreground">Practice with Database & AI modes</p>
                        </div>
        ...
        <section className="mb-8 md:mb-10">
            <Card className="bg-slate-900 text-white border-slate-700 overflow-hidden shadow-lg">
                <div className="p-4 md:p-5">
                    ...
                    <h3 className="text-base md:text-lg font-bold mb-1">Unlock Interview Simulator</h3>
                    <p className="text-xs md:text-sm text-slate-400 mb-4">Practice with real-time AI voice interviews, get performance scoring, and access offline mode.</p>
                    <Button
                      size="sm"
                    ...
                    <Card key={feature.title} className="bg-card border-border shadow-sm">
                        <CardContent className="p-3">
                            <div className="flex justify-between items-center">
                                ...
                                <Badge variant="outline" className="text-[10px] px-2 py-1 whitespace-nowrap text-amber-600 border-amber-500/30 bg-amber-500/10">
                                    Coming Soon
                                </Badge>
                            </div>
                        </CardContent>
        ...
        <section>
            <h2 className="text-base md:text-lg font-bold flex items-center gap-2 mb-4 text-foreground">
