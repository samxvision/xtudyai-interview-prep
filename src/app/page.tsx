...
const categories = [
  {
    ...
    Icon: () => <div className="h-10 w-10 flex items-center justify-center rounded-lg bg-orange-100"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M14.5416 11.25C14.5416 13.79 12.5416 15.872 10.1382 16.216C9.96039 16.24 9.77639 16.25 9.58333 16.25C6.93333 16.25 4.79167 14.1083 4.79167 11.4583C4.79167 9.54167 6.01667 7.94167 7.63333 7.25833C7.63333 7.25833 7.85833 6.025 8.75 5.13333C9.46864 4.41469 10.5183 4.36449 11.2833 5C12.3 5.83333 12.125 7.29167 12.125 7.29167C13.55 7.725 14.5416 9.35 14.5416 11.25Z" stroke="#F97316" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M7.91669 16.25C7.31484 15.3503 6.94042 14.288 6.84169 13.125" stroke="#F97316" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M12.9167 12.0833C13.5417 10.6667 13.3333 9 12.125 7.29167" stroke="#F97316" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></div>,
  ...
  },
  {
    ...
    Icon: () => <div className="h-10 w-10 flex items-center justify-center rounded-lg bg-purple-100"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12.9667 10.4167C14.7167 10.4167 16.1333 8.99167 16.1333 7.25C16.1333 5.50833 14.7167 4.08333 12.9667 4.08333C11.225 4.08333 9.8 5.50833 9.8 7.25C9.8 8.99167 11.225 10.4167 12.9667 10.4167Z" stroke="#8B5CF6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M9.84167 11.0583L8.65833 12.2417C6.70833 14.1917 6.70833 17.225 8.65833 19.175C10.6083 21.125 13.6417 21.125 15.5917 19.175L16.775 18C17.55 17.225 17.55 16 16.775 15.225L15.225 13.675C14.45 12.9 13.225 12.9 12.45 13.675L11.0583 15.0667" stroke="#8B5CF6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M9.80005 9.80005L1.66675 1.66675" stroke="#8B5CF6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M3.75 1.66667H1.66667V3.75" stroke="#8B5CF6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></div>,
